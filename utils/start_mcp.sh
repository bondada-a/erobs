...
# Usage: ./utils/start_mcp.sh [beambot launch args]
# Examples:
#   ./utils/start_mcp.sh
#   ./utils/start_mcp.sh use_mock_hardware:=true enable_vision:=false enable_pipettor:=false
#   ./utils/start_mcp.sh enable_vision:=false
