...
class MTCGUIClient:
    """Simple MTC GUI Client without ROS2 dependencies"""
    ...
    def setup_gui(self):
        ...
        self.root = tk.Tk()
        self.root.title("MTC Action Client GUI (Demo Mode)")
    ...
    def _execute_task_thread(self):
        ...
        try:
            ...
            for i, step in enumerate(self.current_config.get('sequence', [])):
                ...
                # Update progress
                progress = ((i + 1) / len(self.current_config.get('sequence', []))) * 100
    ...
    def test_connection(self):
        ...
        self.log_message("This is a demonstration GUI. In a real ROS2 environment, this would test the action server connection.")
    ...
    def show_about(self):
        ...
        messagebox.showinfo("About", 
                          "MTC Action Client GUI (Demo Mode)\n\n"
                          "A graphical interface for the MoveIt Task Constructor (MTC) action client.\n"
                          "This is a demonstration version that runs without ROS2.\n"
                          "Allows you to create, edit, and simulate robot task sequences.\n\n"
                          "Version: 1.0 (Demo)")
