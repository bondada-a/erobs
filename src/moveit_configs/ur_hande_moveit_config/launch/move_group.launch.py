...
def generate_launch_description():
    ...
    description_file = DeclareLaunchArgument('description_file', default_value='ur_with_toolexchanger.xacro')
    ...
    moveit_config = (
        ...
        .robot_description(file_path=os.path.join(get_package_share_directory("ur5e_hande_robot_description"), "urdf", "ur_with_toolexchanger.xacro"),mappings=xacro_args)
