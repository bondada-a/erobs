...
def generate_launch_description():
    ...
    description_file = DeclareLaunchArgument('description_file', default_value=os.path.join(get_package_share_directory("ur5e_hande_robot_description"), "urdf", "ur_with_zivid_hande.xacro"))
    ...
    rviz_config = PathJoinSubstitution([
        FindPackageShare("ur_zivid_hande_moveit_config"), "rviz", LaunchConfiguration("rviz_config")
    ])
