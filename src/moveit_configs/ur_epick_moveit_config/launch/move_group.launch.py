...
def generate_launch_description():
    ...
    description_file = DeclareLaunchArgument('description_file', default_value='ur_with_epick.xacro')
    controllers_file = DeclareLaunchArgument('controllers_file', default_value=os.path.join(get_package_share_directory("ur_epick_moveit_config"), "config", "ur_epick_controllers.yaml"))
    ...
    moveit_config = (
        MoveItConfigsBuilder("ur_moveit",package_name="ur_epick_moveit_config")
        .robot_description(file_path=os.path.join(get_package_share_directory("ur5e_hande_robot_description"), "urdf", "ur_with_epick.xacro"),mappings=xacro_args)
